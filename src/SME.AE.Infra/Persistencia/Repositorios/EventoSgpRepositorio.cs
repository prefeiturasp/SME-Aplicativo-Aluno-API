...
namespace SME.AE.Infra.Persistencia.Repositorios
{
    public class EventoSgpRepositorio : IEventoSgpRepositorio
    {
        ...
        public async Task<IEnumerable<EventoSgpDto>> ListaEventoPorDataAlteracao(DateTime ultimaDataAlteracao, int pagina, int quantidadeRegistrosPorPagina)
        {
            ...
            var eventosSgp = await conn.QueryAsync<EventoSgpDto>(sql, new { ultimaDataAlteracao = ultimaDataAlteracao.Date, pagina, quantidadeRegistrosPorPagina}, commandTimeout: 120);
