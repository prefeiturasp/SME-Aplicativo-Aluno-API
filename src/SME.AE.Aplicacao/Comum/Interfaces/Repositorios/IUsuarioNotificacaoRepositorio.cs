...
namespace SME.AE.Aplicacao.Comum.Interfaces.Repositorios
{
    public interface IUsuarioNotificacaoRepositorio
    {
        ...
        public Task<long> ObterTotalNotificacoesLeituraPorResponsavel(long notificacaoId);
        public Task<long> ObterTotalNotificacoesLeituraPorAluno(long notificacaoId);
    }
}