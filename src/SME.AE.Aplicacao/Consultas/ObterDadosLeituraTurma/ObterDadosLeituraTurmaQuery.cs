...
namespace SME.AE.Aplicacao.Consultas.ObterDadosLeituraComunicados
{
    public class ObterDadosLeituraTurmaQuery : IRequest<IEnumerable<DadosLeituraComunicadosPorModalidadeTurmaResultado>>
    {
        ...
        public ObterDadosLeituraTurmaQuery(string codigoDre, string codigoUe, long notificaoId, short[] modalidades, long codigoTurma, ModoVisualizacao modoVisualizacao)
        {
            CodigoDre = codigoDre;
            CodigoUe = codigoUe;
