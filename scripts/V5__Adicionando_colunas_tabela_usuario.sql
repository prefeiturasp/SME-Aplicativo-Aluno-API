...
ALTER TABLE if exists public.usuario ADD if not exists primeiroacesso bool NOT NULL;
ALTER TABLE if exists public.usuario ADD if not exists alteradoem timestamp NULL;
ALTER TABLE if exists public.usuario ADD if not exists criadopor varchar(200) NOT NULL;
