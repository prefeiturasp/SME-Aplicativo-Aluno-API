...
namespace SME.AE.Aplicacao.Teste.CasosDeUso.Autenticacao
{
    public class PrimeiroAcessoUseCaseTeste : BaseTeste
    {
        ...
        private void InstanciarComandos() 
        {
            ...
            mediator.Setup(a => a.Send(It.IsAny<ObterDadosResumidosReponsavelPorCpfQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(responsavelAlunoEolResumidoDto);
        ...
        private ResponsavelAlunoEolResumidoDto responsavelAlunoEolResumidoDto { get; set; } = new ResponsavelAlunoEolResumidoDto
        {
           Celular = "999999999",
           DDD = "99",
